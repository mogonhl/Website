        ...
        for (let i = 0; i < parseInt(numChunks); i++) {
            ...
            if (chunkData) {
                ...
                tokens.forEach(token => {
                    ...
                    // Create snapshot data for chart (last 24 points = 1 day of hourly data)
                    const snapshotData = token.prices.slice(-24).map(([timestamp, price]) => ({
                        time: timestamp,
                        price: price
                    }));
                    ...
                    consolidatedData[token.tokenId] = {
                        ...
                        s: snapshotData // snapshot data for chart
                    };
